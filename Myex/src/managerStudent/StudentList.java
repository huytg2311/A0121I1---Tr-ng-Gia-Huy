...
class StudentList {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        // Check if name exist
        System.out.println("Name \"Truong Gia Huy\""+ (list.hasName("Truong Gia Huy") ? " " : " NOT ") + "exist");

        // Remove name
        list.removeName("Truong Gia Huy");
...
class Student {
    ...
    public String toString() {
        return "{" +
                " name='" + getName() + "'" +
                ", Điểm toán='" + getMathMark() + "'" +
                ", Điểm Lý='" + getPhysicMark() + "'" +
                ", Điểm Văn='" + getLanguageMark() + "'" +
                "}";
    }
